...
class AppConstants {
  static const String appName = 'Liftmate';
  static const String baseUrl = 'https://liftmate.org';
  ...
  /// Call/Calling APIs
  static const String initiateCall = '/api/customer/call/initiate';
  static const String acceptCall = '/api/customer/call/accept';
  static const String rejectCall = '/api/customer/call/reject';
  static const String endCall = '/api/customer/call/end';
  static const String callHistory = '/api/customer/call/history';
  static const String updateCallStatus = '/api/customer/call/update-status';
  static const String markMessageAsRead = '/api/customer/chat/mark-as-read';
  static const String sendTypingIndicator = '/api/customer/chat/typing-indicator';
  
  /// Subscription APIs
  static const String getSubscriptionPlans = '/api/customer/subscription/plans';
  static const String getUserSubscription = '/api/customer/subscription/my-subscription';
  static const String purchaseSubscription = '/api/customer/subscription/purchase';
  static const String cancelSubscription = '/api/customer/subscription/cancel';
  static const String renewSubscription = '/api/customer/subscription/renew';

  /// Invoice APIs
  static const String GET_INVOICE_LIST = '/api/customer/invoice/list';
  static const String GET_INVOICE_DETAIL = '/api/customer/invoice/detail';

  /// Spinner/Rewards APIs
  static const String GET_SPINNER_REWARDS = 'rewards/spinner';
  static const String SPIN_WHEEL = 'rewards/spin-wheel';
