...
import 'package:ride_sharing_user_app/features/call/domain/services/call_service.dart';
...
import 'package:ride_sharing_user_app/features/invoice/domain/repositories/invoice_repository.dart';
import 'package:ride_sharing_user_app/features/invoice/domain/repositories/invoice_repository_interface.dart';
import 'package:ride_sharing_user_app/features/invoice/domain/services/invoice_service.dart';
...
import 'package:ride_sharing_user_app/features/rewards/domain/repositories/rewards_repository.dart';
import 'package:ride_sharing_user_app/features/rewards/domain/services/rewards_service.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  Get.lazyPut(() => InvoiceService(invoiceRepositoryInterface: Get.find()));
  Get.lazyPut(() => RewardsService(rewardsRepositoryInterface: Get.find()));
  ...
  Get.lazyPut(() => InvoiceRepository(apiClient: Get.find()));
  Get.lazyPut(() => RewardsRepository(apiClient: Get.find()));
  ...
  Get.lazyPut(() => InvoiceController(invoiceServiceInterface: Get.find()));
  Get.lazyPut(() => RewardsController(rewardsServiceInterface: Get.find()));
  ...
  Get.lazyPut(() => CallController(callServiceInterface: Get.find()));
  Get.lazyPut(() => SubscriptionController(
    subscriptionServiceInterface: Get.find<SubscriptionServiceInterface>(),
  ));
  ...
  InvoiceRepositoryInterface invoiceRepositoryInterface = InvoiceRepository(apiClient: Get.find());
  Get.lazyPut(() => invoiceRepositoryInterface);
  InvoiceServiceInterface invoiceServiceInterface = InvoiceService(invoiceRepositoryInterface: Get.find());
  Get.lazyPut(() => invoiceServiceInterface);
  ...
  CallServiceInterface callServiceInterface = CallService(apiClient: Get.find());
  Get.lazyPut(() => callServiceInterface);

  SubscriptionServiceInterface subscriptionServiceInterface = SubscriptionService(apiClient: Get.find());
