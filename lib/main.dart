...
import 'package:ride_sharing_user_app/core/bindings/initial_binding.dart';
  ...
  if (GetPlatform.isAndroid) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyCckhJY3NMZTjOkXWMJhor_GIMmQflo1U8",
        appId: "1:341343544975:android:10c8c8b38f6cd68b85b2fa",
        messagingSenderId: "341343544975",
        projectId: "lifematedrive",
      ),
    );
  } else {
    await Firebase.initializeApp();
