...
class TripDetails {
  ...
  TripDetails.fromJson(Map<String, dynamic> json) {
    ...
    if(json['distance_fare'] != null){
      distanceFare = json['distance_fare'].toDouble();
    } else {
      distanceFare = 0.0;
    }
    
    if(json['waiting_fare'] != null && json['waiting_fare'] is! String){
      waitingFareDouble = json['waiting_fare'].toDouble();
    } else if(json['waiting_fare'] != null){
      waitingFareDouble = double.tryParse(json['waiting_fare'].toString()) ?? 0.0;
    } else {
      waitingFareDouble = 0.0;
    }
...
class Driver {
  ...
  /// Getter for full name combining first and last name
  String? get name {
