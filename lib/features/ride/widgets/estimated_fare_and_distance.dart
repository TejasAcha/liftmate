        ...
        child: IntrinsicHeight(
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
            Builder(builder: (context) {
              final distance = rideController.remainingDistanceModel.isNotEmpty
                  ? rideController.remainingDistanceModel[0].distanceText ?? '0'
                  : '0';
              final duration = rideController.remainingDistanceModel.isNotEmpty
                  ? rideController.remainingDistanceModel[0].duration ?? ''
                  : '';
              final display = duration.isNotEmpty ? '$distance • $duration' : distance;
              return FareWidget(title: 'distance_away'.tr, value: display);
            }),
