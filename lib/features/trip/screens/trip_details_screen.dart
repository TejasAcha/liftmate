                        ...
                        child: Padding(
                          ...
                          child: Column(children: [
                            ...
                            InkWell(
                              ...
                              child: Text('view_invoice'.tr, style: textRegular.copyWith(
                                  decoration: TextDecoration.underline,
                                  decorationColor: Theme.of(context).colorScheme.inverseSurface,
                                  color: Theme.of(context).colorScheme.inverseSurface
                              )),
                      ...
                      Container(
                        ...
                        child: Column(children: [
                          if(rideController.tripDetails?.driver != null)
                            ButtonWidget(
                              icon: Icons.call,
                              buttonText: 'call_driver'.tr,
                              onPressed: () {
                                Get.find<CallController>().startCall(
                                  recipientId: rideController.tripDetails!.driver!.id.toString(),
                                  recipientName: rideController.tripDetails!.driver!.name ?? 'Driver',
                                  recipientImage: rideController.tripDetails!.driver!.profileImage ?? '',
                                );
                                Get.toNamed(RouteHelper.getCallScreen());
                              },
                            ),
                          const SizedBox(height: Dimensions.paddingSizeSmall),
                          ButtonWidget(
