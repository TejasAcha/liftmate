...
import 'package:ride_sharing_user_app/features/rewards/bindings/rewards_binding.dart';
            ...
            body: SingleChildScrollView(
              ...
              child: Column(children: [
                ...
                ProfileMenuItem(
                  ...
                  onTap: () => Get.to(() => const WheelSpinnerScreen(),
                ...
                ProfileMenuItem(
                  ...
                  icon: Images.profileSubscription,
                  onTap: () =>
                      Get.toNamed(RouteHelper.getSubscriptionPlansScreen()),
                ),
                ProfileMenuItem(
                  title: 'call_history'.tr,
                  icon: Images.profileHistory,
                  onTap: () => Get.toNamed(RouteHelper.getCallHistoryScreen()),
                ),
                ProfileMenuItem(
                  title: 'logout',
